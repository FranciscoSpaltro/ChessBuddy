...
void Board::initialize(void){
    ...
    this -> board[index(6, 0)] = std::make_unique<Rook>(PieceColor::white);
    this -> board[index(6, 1)] = std::make_unique<Knight>(PieceColor::white);
    this -> board[index(6, 2)] = std::make_unique<Bishop>(PieceColor::white);
    this -> board[index(6, 3)] = std::make_unique<Queen>(PieceColor::white);
    this -> board[index(6, 4)] = std::make_unique<King>(PieceColor::white);
    this -> board[index(6, 5)] = std::make_unique<Bishop>(PieceColor::white);
    this -> board[index(6, 6)] = std::make_unique<Knight>(PieceColor::white);
    this -> board[index(6, 7)] = std::make_unique<Rook>(PieceColor::white);
    this -> board[index(7, 0)] = std::make_unique<Pawn>(PieceColor::white);
    this -> board[index(7, 1)] = std::make_unique<Pawn>(PieceColor::white);
    this -> board[index(7, 2)] = std::make_unique<Pawn>(PieceColor::white);
    this -> board[index(7, 3)] = std::make_unique<Pawn>(PieceColor::white);
    this -> board[index(7, 4)] = std::make_unique<Pawn>(PieceColor::white);
    this -> board[index(7, 5)] = std::make_unique<Pawn>(PieceColor::white);
    this -> board[index(7, 6)] = std::make_unique<Pawn>(PieceColor::white);
    this -> board[index(7, 7)] = std::make_unique<Pawn>(PieceColor::white);
}
